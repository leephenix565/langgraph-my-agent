...
STATIC_CODESPELL_TARGETS = (
    ...
    "docs/SYNC_OPS_2A_R5_STABLE_ENVIRONMENT_BINDING.md",
    "docs/SYNC_OPS_2B0_DURABLE_ARTIFACT_STORE_BOOTSTRAP.md",
    "docs/SYNC_OPS_2B0_R1_DURABLE_ARTIFACT_STORE_BOOTSTRAP.md",
    ...
    "docs/SYNC_OPS_5A_R3X_APPROVED_LAUNCH_AUTHORITY.md",
