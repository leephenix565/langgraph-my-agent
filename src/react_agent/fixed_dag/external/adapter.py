...
(Moved from ``fixed_dag_external_adapter.py`` during Phase 1 consolidation.)
"""
...
from react_agent.fixed_dag.catalog import ANN_ID_PATTERN, FORBIDDEN_RESET_AGENT_IDS
