...
from react_agent.ops_sync.sync_inventory import build_runtime_inventory, inventory_root
from react_agent.ops_sync.sync_registry import (
...
from react_agent.ops_sync.sync_summary import p2s_summary_from_plan, summary_consistency
...
def validate_experiment_manifest(manifest: Mapping[str, Any]) -> dict[str, Any]:
    from react_agent.ops_sync.sync_s2p import validate_experiment_contract
...
def build_s2p_plan(experiment_manifest: Mapping[str, Any]) -> dict[str, Any]:
    from react_agent.ops_sync.sync_s2p import build_s2p_plan_v2

    return build_s2p_plan_v2(experiment_manifest)


def build_cycle_plan(s2p_plan: Mapping[str, Any]) -> dict[str, Any]:
    from react_agent.ops_sync.sync_cycle import build_cycle_plan_from_s2p
...
def validate_plan(
    ...
    *,
    ...
    if direction == "p2s":
        ...
        from react_agent.ops_sync.sync_s2p import validate_s2p_plan_contract
