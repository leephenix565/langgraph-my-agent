...
from react_agent.ops_sync.sync_5a_r2x import expires_utc, now_utc, reselect_first_candidate
from react_agent.ops_sync.sync_5a_r3x import build_source_package_provenance
...
from react_agent.ops_sync.sync_s2p import descriptor_from_inventory
...
def build_projected_experiment_v6(selected: Mapping[str, Any], p2s_v6: Mapping[str, Any]) -> dict[str, Any]:
    from react_agent.ops_sync.sync_5a_r5x import build_projected_experiment_v5
...
def build_first_real_cycle_plan_v6(selected: Mapping[str, Any], experiment_v6: Mapping[str, Any], p2s_v6: Mapping[str, Any]) -> dict[str, Any]:
    from react_agent.ops_sync.sync_5a_r5x import build_first_real_cycle_plan_v5
