...
from react_agent.ops_sync.sync_contracts import canonical_sha256, stable_id
...
def validate_full_p2s_rebase_plan_v3(plan: Mapping[str, Any]) -> dict[str, Any]:
    from react_agent.ops_sync.sync_5a_r2x import validate_full_p2s_rebase_plan_v2
