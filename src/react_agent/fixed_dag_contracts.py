...
RESET_RUNTIME_AGENT_IDS: tuple[str, ...] = (
    ...
    "industry_trend_analyst",
    "company_fundamental_analyst",
    "earnings_quality_analyst",
    "valuation_model_analyst",
    "capital_flow_analyst",
    "shareholder_structure_analyst",
    "insider_transaction_analyst",
    "credit_risk_analyst",
    "regulatory_compliance_analyst",
    "esg_risk_analyst",
    "supply_chain_risk_analyst",
    "competitive_position_analyst",
    "scenario_stress_analyst",
...
def build_deterministic_fixed_dag_plan(user_text: str = "") -> FixedDagPlan:
    ...
    steps: list[FixedDagStep] = [
        ...
        },
        {
            "id": "entity_resolve",
            "stage": "evidence",
            "title": "Entity resolve",
            "description": "Resolve mentioned entities without live lookup.",
        ...
        },
        {
            "id": "relation_extract",
            "stage": "evidence",
            "title": "Relation extract",
            "description": "Extract relations from the user question.",
            "agent_id": "relation_extract",
            "status": "pending_implementation",
        },
        {
