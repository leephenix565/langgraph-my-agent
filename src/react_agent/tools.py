...
def _unavailable_search_tool(reason: str) -> BaseTool:
...
def build_tavily_search(max_results: int) -> BaseTool:
    ...
    if TavilySearch is None:
        return _unavailable_search_tool(_TAVILY_IMPORT_ERROR or "missing_langchain_tavily")
    ...
    try:
        ...
        return _unavailable_search_tool(type(exc).__name__)
