...
def _route_prior_shadow() -> dict[str, object]:
    return {
        ...
        "awake_agents": ["a03_macro_industry_research", "a20_compliance_review"],
        "wildcard_agents": [],
        "route_scores": [
            {
            ...
            {
                "agent_id": "a21_portfolio_manager",
...
def test_enabled_reliability_shadow_is_trace_only_and_compact(monkeypatch) -> None:
    ...
    assert trace["top_card_ids"] == ["a03_macro_industry_research", "a20_compliance_review"]
