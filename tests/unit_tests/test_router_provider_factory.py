...
def test_preflight_invocation_policy_fail_closed_cases() -> None:
    cases = [
        (
            RouterProviderInvocationOptions(call_cap=4),
        ...
        (
            RouterProviderInvocationOptions(retry_count=3),
