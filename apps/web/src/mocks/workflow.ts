...
export function createWorkflowVariant(theme: string): WorkflowModel {
  ...
  return {
    ...
    stepResults: {
      ...
      value_traditional_valuation: {
        ...
        agent_evidence: {
          ...
          dimension: "value",
          status: "complete",
          stance: "cautious_positive",
          confidence: 0.62,
          summary: "估值维度给出偏积极但需复核的结构化信号。",
          source: "external_compute_demo",
        },
      },
      sentiment_company_radar: {
        status: "pending_implementation",
      ...
      value_composite: {
        status: "complete",
        runtime_kind: "deterministic_composite",
        implementation_status: "deterministic_skeleton",
        binding_source: "fixed_dag_runtime_registry",
        invoke_enabled: false,
        live_verified: false,
    ...
    provenance: {
      ...
      selectedRoutingRequested: false,
      selectedRoutingFallback: false,
      fallbackReason: null,
      routeGranularity: null,
      selectedDimensions: [],
      expandedAgentCount: null,
      providerRouterEnabled: false,
      providerRouterInvoked: false,
      providerRouterMode: null,
      providerRouterParseOk: false,
