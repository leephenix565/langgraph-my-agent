  ...
  return {
    ...
    dimensionGroups: [
      ...
      },
      {
        ...
        status: "partial",
        summary: "Macro path is represented as a public-safe placeholder.",
      },
    ],
    currentStage: "report",
    ...
    stepResults: {
      ...
      financial_data_service: {
        ...
        invoke_enabled: false,
        live_verified: false,
        warnings: ["External candidate is registered but not live verified in the mock path."],
      },
      ...
      sentiment_company_radar: {
        ...
        invoke_enabled: false,
        live_verified: false,
        warnings: ["Market sentiment path is placeholder-only in the local fixture."],
      },
    },
