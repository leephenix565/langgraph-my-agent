...
export const zhCN = {
  ...
  workflow: {
    ...
    resultFields: {
      ...
      liveVerified: "连接验证",
      warnings: "注意事项",
      agentEvidence: "单体智能体输入",
      compositeEvidence: "综合智能体输入",
      signal: "信号",
      confidence: "置信度",
      summary: "摘要",
      members: "成员",
    ...
    provenance: {
      ...
      limitations: "技术说明",
      selectedRoutingRequested: "选择路由",
      selectedRoutingFallback: "选择路由备用路径",
      fallbackReason: "备用原因",
      routeGranularity: "路由粒度",
      selectedDimensions: "选择维度",
      expandedAgentCount: "展开智能体数",
      providerRouterEnabled: "模型路由开关",
      providerRouterInvoked: "模型路由调用",
      providerRouterMode: "模型路由模式",
      providerRouterParseOk: "模型路由解析",
      providerRouterFallbackReason: "模型路由备用原因",
      providerRouterErrorCode: "模型路由错误码",
      providerRouterSelectedDimensions: "模型路由维度",
      rawDetails: "技术枚举",
    },
    summaryStats: {
      stages: "6 个阶段",
