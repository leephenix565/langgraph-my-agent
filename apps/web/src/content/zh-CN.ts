...
const agentNameLabels: Record<string, string> = {
  a01_cio_orchestrator: "首席投资统筹",
  a02_task_router: "任务路由",
  a03_macro_policy: "宏观政策分析师",
  a04_industry_layout: "行业格局分析师",
  a05_product_pricing: "产品定价分析师",
  a06_financial_reports: "财务报告分析师",
  a07_financial_modeling: "财务建模分析师",
  a08_tech_due_diligence: "技术尽调分析师",
  a09_macro_sentiment: "宏观情绪分析师",
  a10_industry_sentiment: "行业情绪分析师",
  a11_equity_sentiment: "个股情绪分析师",
  a12_ipo_investor_behavior: "IPO 投资者行为分析师",
  a13_index_technical_analysis: "指数技术分析师",
  a14_single_stock_tech: "个股技术分析师",
  a15_research_synthesis: "研究综合分析师",
  a16_fund_manager_behavior: "基金经理行为分析师",
  a17_client_profile: "客户画像分析师",
  a18_primary_secondary_valuation: "一二级估值分析师",
  a19_market_risk: "市场风险监控",
  a20_fundamental_risk: "基本面风险监控",
  a21_reg_compliance: "合规风险监控",
  a22_suitability_review: "适当性复核",
  a23_portfolio_opt: "组合优化分析师",
  a25_report_center: "报告中心",
  a26_sci_tech_valuation: "科创估值分析师",
  a27_portfolio_backtest: "组合回测分析师",
};
