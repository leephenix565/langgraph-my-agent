...
This document has moved to: [docs/history/sync-ops/SYNC_OPS_5A_FIRST_NONZERO_CYCLE_QUALIFICATION.md](history/sync-ops/SYNC_OPS_5A_FIRST_NONZERO_CYCLE_QUALIFICATION.md).
