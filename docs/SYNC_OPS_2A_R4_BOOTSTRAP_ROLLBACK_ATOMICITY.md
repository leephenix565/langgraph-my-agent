...
This document has moved to: [docs/history/sync-ops/SYNC_OPS_2A_R4_BOOTSTRAP_ROLLBACK_ATOMICITY.md](history/sync-ops/SYNC_OPS_2A_R4_BOOTSTRAP_ROLLBACK_ATOMICITY.md).
