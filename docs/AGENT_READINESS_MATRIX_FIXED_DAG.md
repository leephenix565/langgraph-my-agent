...
| `value_composite` | L3 | composite | `dimension_composite_result_v1` | `127.0.0.1:10015` | fail | skipped | skipped | `production_health_failed` | R8-10E health returned value-ML service identity, not value composite identity | Fix production health identity, then resmoke compute | Service health identity fix + R8-10E resmoke | `PROMPT-L3-VALUE-COMPOSITE-BACKFILL` |
