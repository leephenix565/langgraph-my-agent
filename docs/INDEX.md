...
| `docs/FULL_SANDBOX_PROD_BACKFILL_CLOSURE.md` | BF-COMPLETE-X sandbox-to-prod backfill completion wave: final 31-unit ledger, entity/sentiment production backfill, final-trace validation blocker, and non-claims. |
