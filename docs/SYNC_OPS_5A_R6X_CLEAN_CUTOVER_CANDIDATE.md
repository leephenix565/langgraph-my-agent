...
This document has moved to: [docs/history/sync-ops/SYNC_OPS_5A_R6X_CLEAN_CUTOVER_CANDIDATE.md](history/sync-ops/SYNC_OPS_5A_R6X_CLEAN_CUTOVER_CANDIDATE.md).
