...
This document has moved to: [docs/history/sync-ops/SYNC_OPS_2A_R3_ARTIFACT_STORE_BOOTSTRAP.md](history/sync-ops/SYNC_OPS_2A_R3_ARTIFACT_STORE_BOOTSTRAP.md).
