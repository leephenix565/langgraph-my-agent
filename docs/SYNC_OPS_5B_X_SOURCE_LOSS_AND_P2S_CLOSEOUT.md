...
This document has moved to: [docs/history/sync-ops/SYNC_OPS_5B_X_SOURCE_LOSS_AND_P2S_CLOSEOUT.md](history/sync-ops/SYNC_OPS_5B_X_SOURCE_LOSS_AND_P2S_CLOSEOUT.md).
