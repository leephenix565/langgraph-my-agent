...
| L1 | Local mock contract passes | Mocked request/response tests prove envelope shape, status handling, no secrets, no traceback, and bounded payloads. | Ready for adapter mapping review. |
