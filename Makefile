.PHONY: all format lint test tests test_watch integration_tests docker_tests help extended_tests quality quality_static quality_unit quality_public_api quality_graph_smoke quality_frontend quality_fusion_gate quality_provider_smoke
...
test:
	python scripts/quality/run_quality.py --mode unit

integration_tests:
	python scripts/quality/run_quality.py --mode public-api
...
quality_graph_smoke:
	python scripts/quality/run_quality.py --mode graph-smoke
